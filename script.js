function carregaDicionario() {
    var biografias = { 
        bio01: {
            nome: "Angela Davis", 
            imagem: "./img/angela-davis.webp", 
            alt: "Foto de Angela Davis",
        ...
        bio02: {
            ...
            imagem: "./img/carolina-de-jesus.webp", 
            alt: "Foto de Carolina de Jesus",
        ...
        bio03: {
            ...
            imagem: "./img/conceicao-evaristo.webp",
            alt: "Foto de Conceição Evaristo", 
        ...
        bio04: {
            nome: "Lélia Gonzalez", 
            imagem: "./img/lelia-gonzalez.webp", 
            alt: "Foto de Lélia Gonzalez",
        ...
        bio05: {
            ...
            imagem: "./img/marielle-franco.webp", 
            alt: "Foto de Marielle Franco",
        ...
        bio06: {
            nome: "Rosa Parks", 
            imagem: "./img/rosa-parks.webp", 
            alt: "Foto de Rosa Parks",
    ...
    for (var bio in biografias) {
        ...
        '<div class="card">' + 
        '<img src=" ' +
        biografias[bio].imagem + '" alt="' + biografias[bio].alt + '"/>' + 
        "<details>" +
        "<summary>" +
        biografias[bio].nome +
        "</summary>" +
